                      ...
                      <LocalizationProvider dateAdapter={AdapterDayjs}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                          <DatePicker
                            ...
                            onChange={(newValue) => {
                              const end = formik.values[field.name]?.[1] ?? null;
                              handleChange(formik, field.name, [newValue, end]);
                            }}
                          ...
                          <DatePicker
                            ...
                            onChange={(newValue) => {
                              const start = formik.values[field.name]?.[0] ?? null;
                              handleChange(formik, field.name, [start, newValue]);
                            }}
                            renderInput={(params) => <TextField {...params} />}
                          />
                        </Box>
