const esJSON = {
  ...
  source_code_agpl: 'Código fuente (AGPLv3)',
  in_service: 'en servicio',
  downtime_cost_short: 'parada',
  criticality: 'Criticidad',
  ask_about_this_machine: 'Preguntar sobre esta máquina',
  open_wos: 'órdenes abiertas',
  pm_due_soon: 'mantenimiento próximo',
  components_near_limit: 'componentes cerca del límite',
  profile_completeness: 'Perfil de la máquina',
  specs_captured: 'especificaciones capturadas',
  awaiting_verification: 'pendientes de verificar',
  reading_overdue: 'lectura vencida',
  next_pm: 'Próximo mantenimiento',
  specs: 'Especificaciones',
  parts_bom: 'Piezas y despiece',
  documents: 'Documentos',
  equipment_breakdown: 'Desglose del equipo',
  could_not_load_structure: 'No se pudo cargar la estructura de la máquina',
  no_structure_yet: 'Esta máquina todavía no tiene estructura de desglose.',
  instantiate_a_pack_to_build_it: 'Instancie un paquete para crearla.',
  critical_position: 'Posición crítica',
  SERIALIZED: 'Con número de serie',
  LIFE_LIMITED: 'Vida limitada',
  NON_TRACKED: 'Sin seguimiento',
  component: 'Componente',
  installed: 'Instalado',
  could_not_load_specs: 'No se pudieron cargar las especificaciones',
  required_captured: 'obligatorias capturadas',
  still_missing: 'Todavía faltan',
  verify_all: 'Verificar todo',
  values_extracted_awaiting_verification: 'valores extraídos de documentos esperan su confirmación',
  specs_verified: 'Especificaciones verificadas',
  could_not_verify_specs: 'No se pudieron verificar las especificaciones',
  extracted_value: 'Valor extraído',
  verify: 'verificar',
  verified: 'Verificado',
  no_specs_captured_yet: 'Todavía no se han capturado especificaciones para esta máquina.',
  general: 'General',
  add_spec: 'Añadir especificación',
  spec_key: 'Clave de especificación',
  spec_group: 'Grupo',
  label: 'Etiqueta',
  spec_name_required: 'Ponle un nombre a la especificación',
  spec_label_placeholder: 'p. ej. Velocidad máxima del husillo',
  spec_key_helper: 'Opcional. Identificador estable; se deriva del nombre si se deja vacío.',
  spec_added: 'Especificación añadida',
  spec_deleted: 'Especificación eliminada',
  could_not_add_spec: 'No se pudo añadir la especificación',
  could_not_save_spec: 'No se pudo guardar la especificación',
  could_not_delete_spec: 'No se pudo eliminar la especificación',
  could_not_unverify_spec: 'No se pudo quitar la verificación',
  confirm_delete_spec: '¿Eliminar esta especificación?',
  value_must_be_a_number: 'Este valor debe ser un número',
  verified_by: 'Verificado por',
  from: 'de',
  bill_of_materials: 'Lista de materiales',
  could_not_load_bom: 'No se pudo cargar la lista de materiales',
  could_not_load_restock_kit: 'No se pudo generar el kit de reposición',
  order_what_is_due: 'Pedir lo que toca',
  restock_kit: 'Kit de reposición',
  based_on_measured_usage: 'Según el uso medido',
  lead_time_exceeds_time_remaining: 'El plazo de entrega supera el tiempo restante — pida hoy',
  order_now: 'Pedir ya',
  due_in: 'vence en',
  estimated_total: 'Total estimado',
  no_bom_captured: 'Todavía no se ha capturado la lista de materiales de esta máquina.',
  qty_per_assembly: 'Cant. por conjunto',
  on_hand: 'En stock',
  replacement_interval: 'Intervalo de reemplazo',
  consumable: 'Consumible',
  position: 'Posición',
  could_not_load_documents: 'No se pudieron cargar los documentos',
  search_this_machines_documents: 'Buscar en los manuales, esquemas y catálogos de esta máquina',
  nothing_indexed_matches: 'No hay nada indexado que coincida. Los documentos no lo cubren.',
  no_documents_indexed_for_this_machine: 'Todavía no se ha indexado ningún documento para esta máquina.',
  search_failed: 'La búsqueda falló',
  could_not_open_document: 'No se pudo abrir el documento',
  queued_for_reindexing: 'En cola para reindexar',
  could_not_reindex: 'No se pudo poner en cola para reindexar',
  ingest_status: 'Indexación',
  searchable_sections: 'secciones buscables',
  reindex: 'Reindexar',
  revision: 'Revisión',
  pages: 'Páginas',
  MANUAL: 'Manual',
  ...
  what_costs_this_machine_uptime: 'Qué le cuesta disponibilidad a esta máquina',
  failure_mode: 'Modo de fallo',
  occurrences: 'Ocurrencias',
  downtime: 'Tiempo de parada',
  mtbf: 'MTBF',
  mttr: 'MTTR',
  repair_cost: 'Coste de reparación',
  nothing_recorded_yet: 'Todavía no hay nada registrado para esta máquina.',
  failure: 'Fallo',
  RECEIVED: 'Recibido',
  INSTALLED: 'Instalado',
  REMOVED: 'Retirado',
  OVERHAULED: 'Reacondicionado',
  INSPECTED: 'Inspeccionado',
  REPAIRED: 'Reparado',
  SCRAPPED: 'Desechado',
  MODIFIED: 'Modificado',
  connect_your_own_ai: 'Conecte su propia IA',
  connect_your_own_ai_description: 'Nosotros ponemos los datos, las herramientas y la recuperación. Usted pone el modelo — sus datos no salen de su cuenta y no le cobramos por token.',
  mcp_door_explanation: 'Conecte Claude, ChatGPT, Copilot o Cursor directamente a sus máquinas añadiendo este punto MCP como conector personalizado:',
  ai_provider: 'Proveedor de IA',
  ai_provider_helper: 'Para el chat de la aplicación y el asistente móvil. Los clientes MCP de escritorio no lo necesitan.',
  ai_provider_none: 'Ninguno — solo clientes MCP',
  ai_provider_anthropic: 'Anthropic (su clave)',
  ai_provider_openai: 'OpenAI (su clave)',
  ai_provider_custom: 'Punto compatible con OpenAI',
  ai_provider_managed: 'Complemento gestionado',
  api_key: 'Clave de API',
  api_key_never_returned: 'Se guarda cifrada. Ningún endpoint la devuelve y nunca se registra.',
  paste_your_api_key: 'Pegue su clave de API',
  leave_blank_to_keep: 'déjelo vacío para conservarla',
  key_installed: 'Clave instalada',
  base_url: 'URL base',
  monthly_token_cap: 'Límite mensual de tokens',
  monthly_token_cap_helper: 'Guarda opcional. Aviso al 80 % y parada clara al 100 % — nunca una degradación silenciosa.',
  ai_settings_saved: 'Configuración de IA guardada',
  could_not_save_ai_settings: 'No se pudo guardar la configuración de IA',
  could_not_load_ai_settings: 'No se pudo cargar la configuración de IA',
  api_key_removed: 'Clave de API eliminada',
  ai_usage: 'Uso de IA',
  conversations: 'Conversaciones',
  tokens_this_month: 'Tokens este mes',
  ...
  failure_capture_description: 'Quince segundos ahora es lo que hace que el historial de fiabilidad valga la pena después. Omítalo si no está seguro.',
  ranked_by_this_machines_history: 'Ordenado por lo que ya le ha pasado a esta máquina',
  no_failure_modes_for_this_class: 'Todavía no hay modos de fallo catalogados para esta clase de equipo',
  how_was_it_detected: '¿Cómo se detectó?',
  downtime_minutes: 'Parada (minutos)',
  cause: 'Causa raíz',
  cause_helper: 'La condición detrás, no el síntoma',
  corrective_action: 'Qué se hizo',
  record_failure: 'Registrar',
  skip: 'Omitir',
  failure_recorded: 'Fallo registrado',
  could_not_record_failure: 'No se pudo registrar el fallo',
  OPERATOR: 'Lo notó el operador',
  PM_INSPECTION: 'Encontrado en una inspección preventiva',
  CONDITION_MONITORING: 'Detectado por monitoreo de condición',
  BREAKDOWN: 'Se averió',
  commissioning: 'Puesta en marcha',
  commissioning_description: 'Documente una máquina por completo delante del cliente. Primero el paquete, luego todos los documentos de una vez, y después apruebe en lote los valores extraídos.',
  which_machine: '¿Qué máquina?',
  pick_a_machine_to_start: 'Elija una máquina para empezar.',
  step_instantiate_pack: '1. Construir la estructura',
  step_instantiate_pack_description: 'Instanciar un paquete crea la estructura de desglose, las claves de especificación, los medidores, los planes de mantenimiento, los modos de fallo y los consumibles — cerca del 80 % de la máquina antes de escribir nada.',
  pack: 'Paquete',
  build_it_out: 'Construir',
  could_not_instantiate_pack: 'No se pudo instanciar el paquete',
  step_drop_documents: '2. Cargar todos los documentos',
  step_drop_documents_description: 'Manuales, catálogos de piezas, esquemas. Se ponen en cola y se indexan en segundo plano — nadie espera.',
  choose_files: 'Elegir archivos',
  documents_queued_for_indexing: 'documentos en cola para indexar',
  upload_failed: 'La carga falló',
  step_review_extracted: '3. Aprobar lo extraído',
  step_review_extracted_description: 'Los valores extraídos de los documentos quedan sin verificar. Apruebe el lote y corrija los pocos que estén mal.',
  nothing_awaiting_review: 'No hay nada pendiente de revisión.',
  approve_all: 'Aprobar todo',
  review_one_by_one: 'Revisar uno por uno',
  commissioning_checklist: 'Lista de puesta en marcha',
  pack_instantiated: 'Estructura creada desde un paquete',
  documents_indexed: 'Documentos indexados y buscables',
  required_specs_captured: 'Especificaciones obligatorias capturadas',
  serialized_components_recorded: 'Componentes con número de serie registrados',
  maintenance_plans_active: 'Planes de mantenimiento activos',
  meters_reading: 'Los medidores tienen lecturas',
  open_the_dossier: 'Abrir el expediente',
  // --- Edicion del dossier de la maquina. Ver
  // docs/plans/2026-08-16-asset-tabs-crud-design.md.
  machine_profile: 'Perfil de la maquina',
  equipment_class: 'Clase de equipo',
  equipment_class_description: 'Agrupa maquinas identicas para que un manual, un catalogo de especificaciones y uno de fallos sirvan a todas',
  asset_level: 'Nivel',
  position_code: 'Codigo de posicion',
  tracking_class: 'Seguimiento',
  downtime_cost_per_hour: 'Coste de parada por hora',
  replacement_cost: 'Coste de reposicion',
  functional_description: 'Para que sirve',
  functional_description_description: 'Para que sirve esta maquina, en una frase',
  SITE: 'Planta',
  SYSTEM: 'Sistema',
  EQUIPMENT: 'Maquina',
  SUBUNIT: 'Subconjunto',
  COMPONENT: 'Componente',
  PART: 'Pieza',
  add_position: 'Anadir posicion',
  edit_position: 'Editar posicion',
  confirm_delete_position: 'Eliminar esta posicion? Todo lo que cuelga de ella - posiciones hijas, medidores, ordenes de trabajo e historial - se elimina tambien.',
  position_saved: 'Posicion guardada',
  position_deleted: 'Posicion eliminada',
  could_not_save_position: 'No se pudo guardar la posicion',
  could_not_delete_position: 'No se pudo eliminar la posicion',
  install_component: 'Instalar componente',
  remove_component: 'Retirar componente',
  overhaul: 'Revision general',
  scrap: 'Dar de baja',
  component_installed: 'Componente instalado',
  component_removed: 'Componente retirado',
  component_overhauled: 'Revision registrada',
  component_scrapped: 'Componente dado de baja',
  add_component: 'Anadir componente',
  edit_component: 'Editar componente',
  confirm_delete_component: 'Eliminar este componente y todo su historial?',
  component_saved: 'Componente guardado',
  component_deleted: 'Componente eliminado',
  could_not_save_component: 'No se pudo guardar el componente',
  could_not_delete_component: 'No se pudo eliminar el componente',
  part_type: 'Tipo de pieza',
  hour_limit: 'Limite de horas',
  cycle_limit: 'Limite de ciclos',
  calendar_limit_months: 'Limite de calendario (meses)',
  occurred_at: 'Cuando',
  meter_value: 'Lectura del medidor',
  reason: 'Motivo',
  existing_component: 'Uno ya en stock',
  new_component: 'Uno nuevo',
  no_uninstalled_components: 'No hay componentes sin instalar. Crea uno abajo.',
  serial_number_required: 'El numero de serie es lo que hace trazable al componente',
  add_bom_line: 'Anadir pieza a la lista',
  edit_bom_line: 'Editar linea de la lista',
  confirm_delete_bom_line: 'Quitar esta pieza de la lista de materiales?',
  bom_line_saved: 'Lista de materiales actualizada',
  bom_line_deleted: 'Pieza retirada de la lista de materiales',
  could_not_save_bom_line: 'No se pudo guardar la linea',
  could_not_delete_bom_line: 'No se pudo quitar la pieza',
  availability: 'Inventario',
  in_stock: 'En stock',
  out_of_stock: 'Sin stock',
  not_stocked: 'No se almacena',
  short_by: 'Falta',
  create_new_part: 'Crear una pieza nueva',
  pick_existing_part: 'Elegir una pieza existente',
  part_required: 'Elige o crea una pieza primero',
  replace_interval_hours: 'Sustituir cada (horas)',
  replace_interval_months: 'Sustituir cada (meses)',
  bom_is_the_parts_list: 'Esta es la lista de piezas de la maquina. El inventario viene de las fichas de pieza.',
  files_and_documents: 'Archivos y documentos',
  document_type: 'Tipo',
  confirm_delete_document: 'Eliminar este archivo? Si esta indexado, tambien desaparece de la busqueda.',
  document_deleted: 'Archivo eliminado',
  could_not_delete_document: 'No se pudo eliminar el archivo',
  document_saved: 'Datos guardados',
  could_not_save_document: 'No se pudieron guardar los datos',
  edit_document: 'Editar datos',
  not_indexed: 'Sin indexar',
  files_uploaded: 'archivos subidos',
  could_not_upload: 'Fallo la subida',
  open: 'Abrir',
  OTHER: 'Otro',
  attachment: 'Adjunto',
  drop_files_here: 'Elige archivos para subir',
  indexable_types_are_searchable: 'Los manuales, catalogos de piezas, esquemas, certificados, informes de inspeccion y analisis de aceite se procesan y se pueden buscar. El video y el CAD se guardan pero no se indexan.',
  edit_failure: 'Editar fallo',
  confirm_delete_failure: 'Eliminar este registro de fallo?',
  failure_saved: 'Fallo registrado',
  failure_deleted: 'Registro de fallo eliminado',
  could_not_save_failure: 'No se pudo guardar el fallo',
  could_not_delete_failure: 'No se pudo eliminar el fallo',
  manage_failure_modes: 'Catalogo de fallos',
  add_failure_mode: 'Anadir modo de fallo',
  edit_failure_mode: 'Editar modo de fallo',
  confirm_delete_failure_mode: 'Eliminar este modo de fallo del catalogo?',
  failure_mode_saved: 'Modo de fallo guardado',
  failure_mode_deleted: 'Modo de fallo eliminado',
  could_not_save_failure_mode: 'No se pudo guardar el modo de fallo',
  could_not_delete_failure_mode: 'No se pudo eliminar el modo de fallo',
  code: 'Codigo',
  name_en: 'Nombre (ingles)',
  name_es: 'Nombre (espanol)',
  subunit: 'Subconjunto',
  typical_mechanism: 'Mecanismo tipico',
  typical_causes: 'Causas tipicas',
  detection_methods: 'Como se detecta normalmente',
  default_severity: 'Gravedad por defecto',
  severity: 'Gravedad',
  mechanism: 'Mecanismo',
  detection_method: 'Como se detecto',
  detected_at: 'Detectado en',
  preventive_recommendation: 'Como evitarlo',
  no_failure_modes_for_class: 'Aun no hay modos de fallo catalogados para esta clase de equipo. Anade uno desde el catalogo.',
  failure_mode_required: 'Indica que fallo',
  set_equipment_class_first: 'Asigna una clase de equipo a esta maquina para usar el catalogo de fallos',
  completed_work_orders: 'Completadas',
  new_work_order: 'Nueva orden de trabajo',
  no_completed_work_orders: 'Aun no se ha completado nada en esta maquina',
  meter_saved: 'Medidor guardado',
  meter_deleted: 'Medidor eliminado',
  could_not_save_meter: 'No se pudo guardar el medidor',
  could_not_delete_meter: 'No se pudo eliminar el medidor',
  edit_reading: 'Editar lectura',
  confirm_delete_reading: 'Eliminar esta lectura?',
  reading_saved: 'Lectura guardada',
  reading_deleted: 'Lectura eliminada',
  could_not_save_reading: 'No se pudo guardar la lectura',
