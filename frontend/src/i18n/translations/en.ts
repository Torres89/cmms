const locale = {
  ...
  source_code_agpl: 'Source code (AGPLv3)',
  in_service: 'in service',
  downtime_cost_short: 'downtime',
  criticality: 'Criticality',
  ask_about_this_machine: 'Ask about this machine',
  open_wos: 'open work orders',
  pm_due_soon: 'PM due soon',
  components_near_limit: 'components near limit',
  profile_completeness: 'Machine profile',
  specs_captured: 'specs captured',
  ...
  could_not_load_structure: 'Could not load the machine structure',
  no_structure_yet: 'This machine has no breakdown structure yet.',
  instantiate_a_pack_to_build_it: 'Instantiate a pack to build one.',
  critical_position: 'Critical position',
  SERIALIZED: 'Serialized',
  LIFE_LIMITED: 'Life limited',
  NON_TRACKED: 'Not tracked',
  component: 'Component',
  installed: 'Installed',
  could_not_load_specs: 'Could not load the spec sheet',
  required_captured: 'required captured',
  still_missing: 'Still missing',
  verify_all: 'Verify all',
  values_extracted_awaiting_verification: 'values were extracted from documents and are waiting for you to confirm them',
  specs_verified: 'Specs verified',
  could_not_verify_specs: 'Could not verify the specs',
  extracted_value: 'Extracted value',
  verify: 'verify',
  verified: 'Verified',
  no_specs_captured_yet: 'No specs have been captured for this machine yet.',
  general: 'General',
  add_spec: 'Add spec',
  spec_key: 'Spec key',
  spec_group: 'Group',
  label: 'Label',
  spec_name_required: 'Give the spec a name',
  spec_label_placeholder: 'e.g. Max spindle speed',
  spec_key_helper: 'Optional. A stable identifier — derived from the name if left blank.',
  spec_added: 'Spec added',
  spec_deleted: 'Spec deleted',
  could_not_add_spec: 'Could not add the spec',
  could_not_save_spec: 'Could not save the spec',
  could_not_delete_spec: 'Could not delete the spec',
  could_not_unverify_spec: 'Could not remove the verification',
  confirm_delete_spec: 'Delete this spec?',
  value_must_be_a_number: 'This value must be a number',
  verified_by: 'Verified by',
  from: 'from',
  bill_of_materials: 'Bill of materials',
  could_not_load_bom: 'Could not load the bill of materials',
  could_not_load_restock_kit: 'Could not build the restock kit',
  order_what_is_due: 'Order what\'s due',
  restock_kit: 'Restock kit',
  based_on_measured_usage: 'Based on measured usage',
  lead_time_exceeds_time_remaining: 'The lead time is longer than the time remaining — order today',
  order_now: 'Order now',
  due_in: 'due in',
  estimated_total: 'Estimated total',
  no_bom_captured: 'No bill of materials has been captured for this machine yet.',
  qty_per_assembly: 'Qty / assembly',
  on_hand: 'On hand',
  replacement_interval: 'Replacement interval',
  consumable: 'Consumable',
  position: 'Position',
  could_not_load_documents: 'Could not load the documents',
  search_this_machines_documents: 'Search this machine\'s manuals, schematics and parts catalogs',
  nothing_indexed_matches: 'Nothing indexed matches that. The documents don\'t cover it.',
  no_documents_indexed_for_this_machine: 'No documents have been indexed for this machine yet.',
  search_failed: 'The search failed',
  could_not_open_document: 'Could not open the document',
  queued_for_reindexing: 'Queued for reindexing',
  could_not_reindex: 'Could not queue for reindexing',
  ingest_status: 'Indexing',
  searchable_sections: 'searchable sections',
  reindex: 'Reindex',
  revision: 'Revision',
  pages: 'Pages',
  MANUAL: 'Manual',
  ...
  FAILED: 'Failed',
  SKIPPED: 'Not indexed',
  could_not_load_history: 'Could not load the history',
  what_costs_this_machine_uptime: 'What costs this machine its uptime',
  ...
  nothing_recorded_yet: 'Nothing has been recorded for this machine yet.',
  failure: 'Failure',
  RECEIVED: 'Received',
  INSTALLED: 'Installed',
  REMOVED: 'Removed',
  ...
  SCRAPPED: 'Scrapped',
  MODIFIED: 'Modified',
  connect_your_own_ai: 'Connect your own AI',
  connect_your_own_ai_description: 'We supply the data, the tools and the retrieval. You supply the model — your data never leaves your tenancy and there is no per-token cost from us.',
  mcp_door_explanation: 'Connect Claude, ChatGPT, Copilot or Cursor directly to your machines by adding this MCP endpoint as a custom connector:',
  ai_provider: 'AI provider',
  ai_provider_helper: 'For the in-app chat and the mobile assistant. Desktop MCP clients don\'t need this.',
  ai_provider_none: 'None — MCP clients only',
  ai_provider_anthropic: 'Anthropic (your key)',
  ai_provider_openai: 'OpenAI (your key)',
  ai_provider_custom: 'Custom OpenAI-compatible endpoint',
  ai_provider_managed: 'Managed add-on',
  api_key: 'API key',
  api_key_never_returned: 'Stored encrypted. It is never returned by any endpoint and never logged.',
  paste_your_api_key: 'Paste your API key',
  leave_blank_to_keep: 'leave blank to keep it',
  key_installed: 'Key installed',
  base_url: 'Base URL',
  monthly_token_cap: 'Monthly token cap',
  monthly_token_cap_helper: 'Optional guard. You get a warning at 80% and a clear stop at 100% — never a silent degradation.',
  ai_settings_saved: 'AI settings saved',
  could_not_save_ai_settings: 'Could not save the AI settings',
  could_not_load_ai_settings: 'Could not load the AI settings',
  ...
  failure_capture_description: 'Fifteen seconds now is what makes the reliability history worth having later. Skip it if you\'re not sure.',
  ranked_by_this_machines_history: 'Ranked by what has happened to this machine before',
  no_failure_modes_for_this_class: 'No failure modes are catalogued for this machine\'s equipment class yet',
  how_was_it_detected: 'How was it caught?',
  downtime_minutes: 'Downtime (minutes)',
  cause: 'Root cause',
  cause_helper: 'The condition behind it, not the symptom',
  corrective_action: 'What was done',
  record_failure: 'Record',
  skip: 'Skip',
  failure_recorded: 'Failure recorded',
  could_not_record_failure: 'Could not record the failure',
  OPERATOR: 'Operator noticed it',
  PM_INSPECTION: 'Found during a PM inspection',
  CONDITION_MONITORING: 'Condition monitoring flagged it',
  BREAKDOWN: 'It broke down',
  commissioning: 'Commissioning',
  commissioning_description: 'Get a machine fully documented in front of the customer. Pack first, then every document at once, then approve the extracted values in a batch.',
  which_machine: 'Which machine?',
  pick_a_machine_to_start: 'Pick a machine to start commissioning it.',
  step_instantiate_pack: '1. Build out the structure',
  step_instantiate_pack_description: 'Instantiating a pack creates the breakdown structure, spec keys, meters, PM plans, failure modes and consumables — about 80% of the machine before anyone types anything.',
  pack: 'Pack',
  build_it_out: 'Build it out',
  could_not_instantiate_pack: 'Could not instantiate the pack',
  step_drop_documents: '2. Drop in every document',
  step_drop_documents_description: 'Manuals, parts catalogs, schematics. They are queued and indexed in the background — nobody waits.',
  choose_files: 'Choose files',
  documents_queued_for_indexing: 'documents queued for indexing',
  upload_failed: 'The upload failed',
  step_review_extracted: '3. Approve what was extracted',
  step_review_extracted_description: 'Values pulled out of the documents land unverified. Approve the batch, then correct the few that are wrong.',
  nothing_awaiting_review: 'Nothing is waiting for review.',
  approve_all: 'Approve all',
  review_one_by_one: 'Review one by one',
  commissioning_checklist: 'Commissioning checklist',
  pack_instantiated: 'Structure built from a pack',
  documents_indexed: 'Documents indexed and searchable',
  required_specs_captured: 'Required specs captured',
  serialized_components_recorded: 'Serialized components recorded',
  maintenance_plans_active: 'Maintenance plans active',
  meters_reading: 'Meters have readings',
  open_the_dossier: 'Open the dossier',
  // --- Asset dossier editing (machine profile, structure, BOM, documents,
  // history, meters). See docs/plans/2026-08-16-asset-tabs-crud-design.md.
  machine_profile: 'Machine profile',
  equipment_class: 'Equipment class',
  equipment_class_description: 'Groups identical machines so one manual, spec catalog and failure catalog serve them all',
  asset_level: 'Level',
  position_code: 'Position code',
  tracking_class: 'Tracking',
  downtime_cost_per_hour: 'Downtime cost per hour',
  replacement_cost: 'Replacement cost',
  functional_description: 'What it does',
  functional_description_description: 'What this machine is for, in a sentence',
  SITE: 'Site',
  SYSTEM: 'System',
  EQUIPMENT: 'Machine',
  SUBUNIT: 'Subunit',
  ...
  confirm_delete_position: 'Delete this position? Everything beneath it - child positions, meters, work orders and history - goes with it.',
  position_saved: 'Position saved',
  position_deleted: 'Position deleted',
  could_not_save_position: 'Could not save the position',
  could_not_delete_position: 'Could not delete the position',
  ...
  component_overhauled: 'Overhaul recorded',
  component_scrapped: 'Component scrapped',
  add_component: 'Add component',
  edit_component: 'Edit component',
  confirm_delete_component: 'Delete this component and its whole history?',
  component_saved: 'Component saved',
  component_deleted: 'Component deleted',
  could_not_save_component: 'Could not save the component',
  could_not_delete_component: 'Could not delete the component',
  part_type: 'Part type',
  hour_limit: 'Hour limit',
  cycle_limit: 'Cycle limit',
  calendar_limit_months: 'Calendar limit (months)',
  occurred_at: 'When',
  meter_value: 'Meter reading',
  reason: 'Reason',
  existing_component: 'One already in stock',
  new_component: 'A new one',
  no_uninstalled_components: 'No uninstalled components. Create one below.',
  serial_number_required: 'A serial number is what makes this component traceable',
  add_bom_line: 'Add part to BOM',
  edit_bom_line: 'Edit BOM line',
  confirm_delete_bom_line: 'Remove this part from the bill of materials?',
  bom_line_saved: 'Bill of materials updated',
  bom_line_deleted: 'Part removed from the bill of materials',
  could_not_save_bom_line: 'Could not save the BOM line',
  could_not_delete_bom_line: 'Could not remove the part',
  ...
  pick_existing_part: 'Pick an existing part',
  part_required: 'Choose or create a part first',
  replace_interval_hours: 'Replace every (hours)',
  replace_interval_months: 'Replace every (months)',
  bom_is_the_parts_list: 'This is the parts list for the machine. Inventory levels come from the part records.',
  files_and_documents: 'Files & Documents',
  document_type: 'Type',
  confirm_delete_document: 'Delete this file? If it is indexed, it disappears from search too.',
  document_deleted: 'File deleted',
  could_not_delete_document: 'Could not delete the file',
  document_saved: 'Details saved',
  could_not_save_document: 'Could not save the details',
  edit_document: 'Edit details',
  not_indexed: 'Not indexed',
  files_uploaded: 'files uploaded',
  could_not_upload: 'Upload failed',
  open: 'Open',
  OTHER: 'Other',
  attachment: 'Attachment',
  drop_files_here: 'Choose files to upload',
  indexable_types_are_searchable: 'Manuals, parts catalogs, schematics, certificates, inspection reports and oil analyses are parsed and become searchable. Video and CAD are stored but not indexed.',
  edit_failure: 'Edit failure',
  confirm_delete_failure: 'Delete this failure record?',
  failure_saved: 'Failure recorded',
  failure_deleted: 'Failure record deleted',
  could_not_save_failure: 'Could not save the failure',
  could_not_delete_failure: 'Could not delete the failure',
  manage_failure_modes: 'Failure catalog',
  add_failure_mode: 'Add failure mode',
  edit_failure_mode: 'Edit failure mode',
  confirm_delete_failure_mode: 'Delete this failure mode from the catalog?',
  failure_mode_saved: 'Failure mode saved',
  failure_mode_deleted: 'Failure mode deleted',
  could_not_save_failure_mode: 'Could not save the failure mode',
  could_not_delete_failure_mode: 'Could not delete the failure mode',
  code: 'Code',
  name_en: 'Name (English)',
  name_es: 'Name (Spanish)',
  subunit: 'Subunit',
  typical_mechanism: 'Typical mechanism',
  typical_causes: 'Typical causes',
  detection_methods: 'How it is usually caught',
  default_severity: 'Default severity',
  severity: 'Severity',
  mechanism: 'Mechanism',
  detection_method: 'How it was caught',
  detected_at: 'Caught at',
  preventive_recommendation: 'How to prevent it',
  no_failure_modes_for_class: 'No failure modes are catalogued for this equipment class yet. Add one from the failure catalog.',
  failure_mode_required: 'Pick what failed',
  set_equipment_class_first: 'Set an equipment class on this machine to use the failure catalog',
  completed_work_orders: 'Completed',
  new_work_order: 'New work order',
  no_completed_work_orders: 'Nothing completed on this machine yet',
  meter_saved: 'Meter saved',
  meter_deleted: 'Meter deleted',
  could_not_save_meter: 'Could not save the meter',
  could_not_delete_meter: 'Could not delete the meter',
  edit_reading: 'Edit reading',
  confirm_delete_reading: 'Delete this reading?',
  reading_saved: 'Reading saved',
  reading_deleted: 'Reading deleted',
  could_not_save_reading: 'Could not save the reading',
